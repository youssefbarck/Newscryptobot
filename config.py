...
REJECTION_KEYWORDS = [
    ...
    # عربية — نشرة يومية / ترويجي
    "هل تريد معرفة", "إليك عن", "اليوم في عالم",
    "ما حدث في عالم", "أحدث الأخبار", "ملخص اليوم",
    "اتجاهات اليوم", "الأحداث اليومية",
    "تعرف على أهم", "أبرز الأحداث",
    "تشاهدون", "تابعونا", "لا تفوت",
    "في هذا الفيديو", "في هذه الحلقة",
]
